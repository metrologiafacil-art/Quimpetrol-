...
const LoadingFallback = () => (
  <div className="flex justify-center items-center h-full min-h-[50vh]">
     <div className="flex space-x-3">
       <div className="w-3 h-3 bg-[#002d62] rounded-full animate-bounce"></div>
       <div className="w-3 h-3 bg-[#e30613] rounded-full animate-bounce delay-75"></div>
       <div className="w-3 h-3 bg-[#f47920] rounded-full animate-bounce delay-150"></div>
     </div>
  </div>
);
